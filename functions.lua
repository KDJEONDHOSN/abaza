...
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/abaza/blob/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████ @WtttW      |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/abaza/blob/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/abaza/blob/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/abaza/blob/master/inc/functions.lua','./inc/functions.lua')
...
usernn = data.username_ or "tft4t"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "tft4t"
end
Name = Name:gsub('[[][]]','')
...
message = message ..i.. '-l ['..info.username..'](t.me/tft4t) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/tft4t) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/tft4t) l » (`' ..v.. '`) \n'
end
end
end
