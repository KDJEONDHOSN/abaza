...
elseif UserID == 1433113424 or UserID == 1619524486  then  
...
if UserID == 1433113424 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1433113424 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/KDJEONDHOSN/KDJEONDHOSN.github.io/main/GetVersion.txt') or "0"
...
local inline = {{{text="قناه‏‏ السـورس : حمد ",url="t.me/tft4t"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: حمد](t.me/tft4t)',nil,inline,msg.id_)
return false
end
...
local inline = {
{{text = '-𝐃𝐄𝐕 👑',url="https://t.me/wtttw"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end


if MsgText[1] == "حمد" then
local text = " [مطور السورس🌐 ](t.me/wtttw)"
local inline = {
{{text = '-𝙳𝙴𝚅 👑',url="https://t.me/wtttw"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local text = " 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 ⩫ "
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 ⩫ ',url="https://t.me/tft4t"}},
{{text = '-𝘿𝙀𝙑   👑',url="https://t.me/wtttw"}},
{{text = '-𝙏𝙒𝘼𝙎𝙊𝙇 💬 ',url="https://t.me/mkkbot"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/KDJEONDHOSN/abaza/main/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 1433113424 or UserID == 1619524486then 
...
if msg.adduser == 1433113424 or msg.adduser ==  1619524486 then 
gtupe = 'مطور السورس' 
...
elseif Text== "مطور السورس" or Text== "بيسو" or Text== "فواز" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس👑](T.ME/wtttw)")
